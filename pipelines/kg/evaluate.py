...
if __name__ == "__main__":
    '''
    invoke:
    aws s3 cp s3://sm-nlp-data/ie-baseline/processed/test.json /opt/ml/processing/input/data/
    aws s3 cp s3://sm-nlp-data/ie-baseline/outputs/pytorch-training-2021-08-28-08-54-39-891/output/model.tar.gz /opt/ml/processing/input/model/
    aws s3 cp s3://sm-nlp-data/pytorch-training-2021-08-28-10-16-26-673/source/sourcedir.tar.gz /opt/ml/processing/input/source/train/
    python evaluate.py --source-dir /opt/ml/processing/input/source/train
    '''
    args = parse_args()
