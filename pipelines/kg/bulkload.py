...
def parse_args():
    ...
    parser.add_argument('--role', type=str, required=False, help='an iam role attached to Neptune to access aws services')
    parser.add_argument('--region', type=str,required=False, help='region of Neptune database')
    parser.add_argument('--neptune-endpoint',required=False, type=str, help='https://your-neptune-endpoint:port')
...
if __name__ == '__main__':
    '''
    Invoke
    python bulkload.py --raw-dataset /Users/yuanchu/Downloads/sourcedir/DuIE_2_0.zip --transformed-data data/psudo.json.out \
        --bucket sm-nlp-data --save-prefix 'ie-baseline/outputs'  --role arn:aws:iam::093729152554:role/NeptuneLoadFromS3 \
        --region us-east-1 --neptune-endpoint 'https://database-2-instance-1.c2ycbhkszo5s.us-east-1.neptune.amazonaws.com:8182'
    '''
    args, _ = parse_args()
    print(args)
